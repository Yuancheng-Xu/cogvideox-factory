...
Clone the repository and make sure the requirements are installed: `pip install -r requirements.txt` and then install diffusers from source by `pip install git+https://github.com/huggingface/diffusers`
